...
vending and then take the mean of the entry variable, which is logical,
to produce the desired proportion:
...
This produces a dataframe in which the number of rows is the number of
distict stations that serve the A train:
...
This produces a dataframe in which the number of rows is the number of
distict stations that serve the A train and are ADA compliant:
